        ...
        <div className="body">
                <div className="filter">
                    <div className="search">
                        <input type="text" className="search-box" value={searchVal} onChange={(e) => {
                            setSearchVal(e.currentTarget.value)
                            
                        }}/>
                        <button onClick={()=>{
                            const searchedList = listOfRest.filter(elem => elem.info.name.toLowerCase().includes(searchVal.toLowerCase()))
                ...
                <div className="restaurant-cont">
                    ...
                    { filteredRestaurant.map( restro => <RestaurantContainer key={restro.info.id} resData={restro}/>) }
